...
class LevelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val language = intent.extras?.getString(Const.LANGUAGE).toString()
        val difficult = intent.extras?.getString(Const.DIFFICULT).toString()
    ...
    fun openImage(id : String, difficult: String, level: String)
    {
        ...
        storageRef.getFile(localfile).addOnSuccessListener {
            ...
            binding.photo.setImageBitmap(bitmap)//отриманий об'єкт Bitmap встановлюється в якості зображення в ImageView
